...
class NetAPI:
    ...
    def save_file(self, file_info, dir):
        ...
        atime = mtime = file_info.get(self.FILE_TIME_TAG)
    ...
    def send_file(self, path):
        ...
        try:
            ...
            self.send_tag(self.FILE_SIZE_TAG)
            self.send_data(os.path.getmtime())
